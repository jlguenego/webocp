(function(ocp, undefined) {
	...
	ocp.graphic.Graph = function(graph_selector, margin) {
	...
	ocp.graphic.filter_transaction = function(dataset, start_t, end_t) {
		var result = [];
	...
	ocp.graphic.make_average = function(dataset, seconds, start_t, end_t) {
		var result = [];
		var sampling_nbr = 50;
